...
void RenderSceneOB() {
	...
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 0, 0);	  //Передает данные у буфере веришин(начальный индекс, кол-во параметров(X,Y,Z), тип, нужно ли нормализовать, расстояние между двумя эл-ми, смещение в структуре)
...
int main(int argc, char** argv)
{
	...
	glutInitDisplayMode(GLUT_DOUBLE | GLUT_RGBA); 	//Установка режима отображения glutInit. GLU_DOUBLE - двойной буфер, GLUT_RGBA - красный-зеленый-синий-альфа-канал
